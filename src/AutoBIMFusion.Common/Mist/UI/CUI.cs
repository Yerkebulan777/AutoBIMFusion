...
public static class CUI
{
    ...
    {
        var menuGroup = source.MenuGroup;
        return menuGroup.FindMacroGroup(menuGroup.Name) ?? new MacroGroup(menuGroup.Name, menuGroup);
    }

    private static void UpdateMacroProperties(MenuMacro macro, string name, string command, string helpString,
        string imagePath, string CLICommand)
    {
    ...
    private static MenuMacro TryGetUpdateExistingMacro(MenuMacroCollection macros, string name, string command,
    ...
    public static MenuMacro AddMacro(this CustomizationSection source, string name, string command, string elementID,
        string helpString, string imagePath, string CLICommand = "", bool UpdateIfExist = false)
    {
        var macroGroup = source.GetMacroGroup();
        var existingMacro = TryGetUpdateExistingMacro(macroGroup.MenuMacros, name, command, elementID, helpString,
            imagePath, CLICommand, UpdateIfExist);
    ...
    {
        var flyout = new ToolbarFlyout(parent, index)
        {
