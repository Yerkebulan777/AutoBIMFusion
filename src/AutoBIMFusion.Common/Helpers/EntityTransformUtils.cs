...
{
    public static TransformResult TransformEntity(Entity entity, Matrix3d matrix, Transaction?  = null)
    {
        if (entity is Hatch { Associative: true }) return new TransformResult(false, true);
