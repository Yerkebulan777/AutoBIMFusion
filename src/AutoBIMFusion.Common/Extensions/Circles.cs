...
public static class CirclesExtensions
{
    ...
    public static Polyline ToPolyline2Pt(this Circle circle)
    {
        ...
        pline.AddVertexAt(0, new Point2d(circle.Center.X - circle.Radius, circle.Center.Y), bulge, halfWidth,
            halfWidth);
        pline.AddVertexAt(1, new Point2d(circle.Center.X + circle.Radius, circle.Center.Y), bulge, halfWidth,
            halfWidth);
        pline.Closed = true;
        return pline;
    }
    ...
    public static Polyline ToPolyline4Pt(this Circle circle)
    {
        ...
        pline.AddVertexAt(0, new Point2d(circle.Center.X - circle.Radius, circle.Center.Y), bulge, polyWidth,
            polyWidth);
        pline.AddVertexAt(1, new Point2d(circle.Center.X, circle.Center.Y + circle.Radius), bulge, polyWidth,
            polyWidth);
        pline.AddVertexAt(2, new Point2d(circle.Center.X + circle.Radius, circle.Center.Y), bulge, polyWidth,
            polyWidth);
        pline.AddVertexAt(3, new Point2d(circle.Center.X, circle.Center.Y - circle.Radius), bulge, polyWidth,
            polyWidth);
        pline.Closed = true;
        return pline;
    }
