...
public static class FrameworkElementExtensions
{
    public static BitmapSource? CreateElementSnapshot(this FrameworkElement element)
    {
        ...
        int width = (int)Ceiling(element.ActualWidth);
    ...
    public static Cursor CreateCursorFromElement(this FrameworkElement element, Point hotspot)
    {
        ...
        int width = (int)Min(Max(1, element.ActualWidth * scale), 255);
        int height = (int)Min(Max(1, element.ActualHeight * scale), 255);
        ...
        using MemoryStream msCursor = new();
        BinaryWriter bw = new(msCursor);
