...
This project is indexed by GitNexus as **AutoBIMFusion** (2959 symbols, 5887 relationships, 254 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
