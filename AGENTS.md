...
This project is indexed by GitNexus as **AutoBIMFusion** (2760 symbols, 5860 relationships, 240 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
