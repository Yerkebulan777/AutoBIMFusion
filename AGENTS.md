...
This project is indexed by GitNexus as **AutoBIMFusion** (2946 symbols, 5883 relationships, 248 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
