...
This project is indexed by GitNexus as **AutoBIMFusion** (3293 symbols, 6400 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
