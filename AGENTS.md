...
This project is indexed by GitNexus as **AutoBIMFusion** (2963 symbols, 5919 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
