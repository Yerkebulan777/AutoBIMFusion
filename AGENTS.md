...
This project is indexed by GitNexus as **AutoBIMFusion** (3279 symbols, 6387 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
