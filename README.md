...
| 2025 | A25 | .NET 8 | [25.0.1, 25.0.2) | R25.0 |
| 2026 | A26 | .NET 8 | [25.1.0, 25.1.1) | R25.1 |
| 2027 | A27 | .NET 10 | 26.0.* | R26.0 |

A25 и A26 закреплены на последних пакетах AutoCAD.NET под .NET 8: `25.0.2` и `25.1.1` уже требуют .NET 10, а хост 2025/2026 остаётся на .NET 8.
