...
This project is indexed by GitNexus as **AutoBIMFusion** (2771 symbols, 5873 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
