...
This project is indexed by GitNexus as **AutoBIMFusion** (2950 symbols, 5913 relationships, 257 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
