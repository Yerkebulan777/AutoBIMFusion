...
This project is indexed by GitNexus as **AutoBIMFusion** (2936 symbols, 5875 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
