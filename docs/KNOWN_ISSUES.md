...
**Где:** `SmallOutOfFrameEntityCleaner.FindSmallEntitiesOutsideFrame`
...
| Small out-of-frame geometry corruption extents | `SmallOutOfFrameEntityCleaner` (frame-based bbox center detection) |
